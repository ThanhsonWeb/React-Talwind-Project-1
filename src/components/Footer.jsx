			...
			<div className="container mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 md:gap-10 p-6 md:p-10">
				...
				<section>
					...
					<p className="text-[#BFBCB2] text-sm mt-5 mb-3">
						Need help for your dream career? Trust us. With Lesson, study
				...
				{/* 2 */}
				<section>
					<h3 className="text-white font-semibold border-b pb-3 uppercase tracking-wide">
						Support
					</h3>
				...
				<section>
					...
					<address className="flex flex-col space-y-3 mt-4 text-[#BFBCB2] not-italic">
						<p>
							<strong className="text-white">Location:</strong> 27 Division St,
							New York, NY 10002, USA
						</p>
						<p>
							<strong className="text-white">Email:</strong> email@gmail.com
						</p>
						<p>
							<strong className="text-white">Phone:</strong> +000 1234 567 890
						</p>
					</address>
				</section>
			</div>
